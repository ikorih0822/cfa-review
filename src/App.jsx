      ...
      <div key={q.id} style={{...S.card,
        ...
        {a?.confirmed && (<>
          ...
          <div style={{...S.card,padding:"10px 14px",marginBottom:8}}>
            ...
            <ImageDisplay images={q.explanationImages||[]}/>
          </div>
...
function AddQuestion({editQ,setEditQ,addQ,addQs,updateQ,questions,setPage}){
  ...
  return(<div>
    ...
    <ImageUploader images={form.explanationImages||[]} onChange={imgs=>set("explanationImages",imgs)} label="解説"/>
